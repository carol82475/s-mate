...
class MainScaffold extends StatelessWidget {
  ...
  int _locationToIndex(String location) {
    ...
    if (location.startsWith('/trip-planner') || location.startsWith('/itinerary')) return 1;
    if (location.startsWith('/map')) return 2;
    if (location.startsWith('/ai-chat')) return 3;
    if (location.startsWith('/find-travelers') || location.startsWith('/traveler-chat')) return 4;
  ...
  void _onTabTapped(BuildContext context, int index) {
    switch (index) {
      ...
      case 1: context.go('/trip-planner'); break;
      case 2: context.go('/map'); break;
      case 3: context.go('/ai-chat'); break;
      case 4: context.go('/find-travelers'); break;
    }
  }

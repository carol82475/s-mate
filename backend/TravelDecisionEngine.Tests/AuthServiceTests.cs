...
public class AuthServiceTests
{
    ...
    public async Task Login_UnverifiedEmailThrowsUnauthorized()
    {
        ...
        fixture.Users.Users.Single().IsEmailVerified = false;
    ...
    private sealed class FakeUserRepository : IUserRepository
    {
        ...
        public Task AddAsync(User user, string? displayName, CancellationToken cancellationToken)
        {
            Users.Add(user);
        ...
        public Task UpdateProfileAsync(User user, string? displayName, CancellationToken cancellationToken) => Task.CompletedTask;

        public Task<UserProfileResponse?> GetProfileByIdAsync(Guid userId, CancellationToken cancellationToken)
        {
            var user = Users.FirstOrDefault(x => x.UserId == userId && x.DeletedAt == null);
            if (user == null) return Task.FromResult<UserProfileResponse?>(null);

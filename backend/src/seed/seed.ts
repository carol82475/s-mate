...
const seedDatabase = async () => {
  try {
    ...
    await supabaseAdmin.from('emergency_contacts').delete().neq('id', '00000000-0000-0000-0000-000000000000');
    ...
    // Seed safety tips
    logger.info('Seeding safety tips...');
    await supabaseAdmin.from('safety_tips').delete().neq('id', '00000000-0000-0000-0000-000000000000');
    
    await supabaseAdmin.from('safety_tips').insert([
      {
        country: 'Vietnam',
    ...
    // Seed quick phrases
    logger.info('Seeding quick phrases...');
    await supabaseAdmin.from('quick_phrases').delete().neq('id', '00000000-0000-0000-0000-000000000000');
    
    await supabaseAdmin.from('quick_phrases').insert([
      {
        language: 'vi',
        category: 'greetings',
    ...
    logger.info('');
    logger.info('📝 To create test users:');
    logger.info('1. Use Supabase Auth signup in your app');
    logger.info('2. Or use Supabase dashboard to create users');
    logger.info('3. Profiles will be auto-created via trigger');
    logger.info('');

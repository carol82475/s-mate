...
const albumsController = __importStar(require("./albums.controller"));
const auth_middleware_1 = require("../../middlewares/auth.middleware");
const validate_middleware_1 = require("../../middlewares/validate.middleware");
const albums_validation_1 = require("./albums.validation");
const router = (0, express_1.Router)();
router.use(auth_middleware_1.authMiddleware);
router.post("/", albumsController.createAlbum);
router.get("/", albumsController.getAlbums);
router.post("/photos", (0, validate_middleware_1.validate)(albums_validation_1.addTripPhotoSchema), albumsController.addTripPhoto);
